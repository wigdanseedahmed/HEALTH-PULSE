...
const updateUserInformationByID= ((req,res, next) => {
    ...
    User.findByIdAndUpdate({ _id: req.params.id }, {$set:req.body}).then(function () {
...
const updateUserInformationByUsername= ((req,res, next) => {
    //to access :id ---> req.params.id
    User.findOneAndUpdate({ username: req.params.username }, {$set:req.body}).then(function () {
  ...
  const updateUserInformationByEmail= ((req,res, next) => {
    //to access :id ---> req.params.id
    User.findOneAndUpdate({ email: req.params.email }, {$set:req.body}).then(function () {
